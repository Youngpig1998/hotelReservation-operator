...
type Client struct {
	...
	Owner           *examplev1beta1.HotelReservationApp
...
func NewClient(config *rest.Config, scheme *runtime.Scheme, controllerManagerName string, owner *examplev1beta1.HotelReservationApp) (*Client, error) {
